            ...
            <div className="flex flex-col w-64">
                <div className="flex flex-col flex-grow bg-indigo-800 pt-5 pb-4 overflow-y-auto">
                    ...
                    <nav className="flex-1 px-2 bg-indigo-800 space-y-1">
                        ...
                        <svg className="mr-3 h-6 w-6 text-indigo-400 group-focus:text-indigo-300 transition ease-in-out duration-150" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <svg className="mr-3 h-6 w-6 text-indigo-400 group-hover:text-indigo-300 group-focus:text-indigo-300 transition ease-in-out duration-150" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
